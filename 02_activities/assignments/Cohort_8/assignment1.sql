...
CASE WHEN product_qty_type = 'unit' THEN  'unit'
	ELSE 'bulk'
END as prod_qty_type_condensed,
CASE WHEN lower(product_name) like lower('%peppers%') then '1' -- or use COLLATE NOCASE
	ELSE '0'
END as pepper_flag
FROM product;
...
SELECT
customer_first_name, customer_last_name, SUM(quantity * cost_to_customer_per_qty) as total_spend
